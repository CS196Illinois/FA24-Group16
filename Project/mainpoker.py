...
# evaluates on what is assumed to be a seven card set
...
def texas_holdem():
    ...
    print("Community Cards at first: ", community_cards)
    player_best_hand = evaluate_hand(player_hand, community_cards)
    print("Community Cards after: ", community_cards)
    ...
    ///
    '''
    print(evaluate_hand(player_hand, community_cards))
    print(evaluate_hand(bot_hand, community_cards))
